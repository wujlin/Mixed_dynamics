...
{\large Jinlin Wu$^{1,\ast}$, Juan Li$^{2}$, Zhihang Liu$^{3,\ast}$}

\vspace{0.5em}

{\small
$^{1}$Urban Governance and Design Thrust, The Hong Kong University of Science and Technology (Guangzhou), Guangzhou 511400, China\\
$^{2}$School of Journalism and Communication, Lanzhou University, Lanzhou 730000, China\\
$^{3}$Institute of Space and Earth Information Science, The Chinese University of Hong Kong, Shatin, Hong Kong, China\\[0.3em]
$^\ast$Correspondence: jwu923@connect.hkust-gz.edu.cn; zhihangliu@cuhk.edu.hk
}
\end{center}
