...
```
请阅读 docs/internal/DEVELOPMENT.md 中的 Phase 5 部分，了解经验数据验证的完整计划。
...
```
基于 docs/internal/DEVELOPMENT.md Phase 5.2，执行数据预处理：
...
```
基于 docs/internal/DEVELOPMENT.md Phase 5.3，执行假设检验：
...
├── docs/internal/DEVELOPMENT.md          # 开发计划（必读）
