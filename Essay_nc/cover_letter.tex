...
We are pleased to submit our manuscript entitled ``Competing feedback channels drive phase transitions in collective emotion'' for consideration as an Article in \textit{Nature Communications}.
...
We believe the manuscript will interest \textit{Nature Communications} readers because it links media-ecology structure to collective dynamics using a unified theory-to-data evidence chain, with implications for platform governance and crisis communication. By reframing abrupt shifts as structural vulnerability rooted in feedback architecture, the work complements existing models of social tipping points and information ecosystems and suggests actionable, system-level intervention levers.
