...
We are pleased to submit our manuscript entitled ``Competing feedback channels drive phase transitions in collective emotion'' for consideration in \textit{npj Complexity}.
...
We believe the manuscript aligns well with the scope of \textit{npj Complexity}. It demonstrates how competing feedback channels give rise to phase transitions, critical slowing down, and symmetry breaking in a sociotechnical system---core themes in complexity science. The unified theory-to-data evidence chain, spanning mean-field analysis, network simulations, and large-scale empirical validation, exemplifies the multiscale, interdisciplinary approach the journal champions. Beyond theoretical interest, the framework offers actionable levers for platform governance and crisis communication.
