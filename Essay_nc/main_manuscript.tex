...
\begin{center}
{\LARGE\bfseries Competing feedback channels drive phase transitions in collective~emotion}
\end{center}
...
% Author contributions statement removed for double-blind peer review

\section*{Competing interests}
The authors declare no competing interests.

\section*{Materials \& Correspondence}
% Contact information removed for double-blind peer review

\section*{Data availability}
The data that support the findings of this study are available from the corresponding authors upon reasonable request.

\section*{Code availability}
% Code repository link removed for double-blind peer review. Upon acceptance, the code will be made publicly available.
