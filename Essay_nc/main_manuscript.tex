...
% Make this robust to different build working directories (repo root vs subdir builds).
\IfFileExists{supplementary.aux}{%
  \externaldocument{supplementary}%
}{%
  \IfFileExists{Essay_nc/supplementary.aux}{%
    \externaldocument{Essay_nc/supplementary}%
  }{%
...
\author[1]{Juan Li}
\author[2]{Jinlin Wu\textsuperscript{*}}
...
\subsection{Activity and media composition mark fragility in social-media data}
...
Together, the segment-level associations connect moderate-buffer depletion and channel balance to heightened fragility. The activity--jump pattern links elevated activity to larger polarization jumps, while the media-dominance--volatility pattern links shifts in channel balance to reduced resilience. Supplementary Figs.~\ref{fig:supp:scatter-h1-h2}--\ref{fig:supp:eventstudy-h4} report additional diagnostics across datasets and event-aligned analyses under realistic missingness.
...
J.L., J.W., and Z.L. conceived the study. J.W. and Z.L. developed the model and conducted theoretical and simulation analyses. J.L. contributed to empirical interpretation and manuscript refinement. All authors wrote and approved the manuscript.
...
The code that supports the findings of this study is available at \url{https://github.com/wujlin/Mixed_dynamics}.
