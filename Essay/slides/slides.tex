...
\begin{frame}{Mixed-feedback mechanism (two competing channels)}
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{column}{0.45\textwidth}
      \centering
      \includegraphics[width=\linewidth]{mixed_feedback_model.png}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}{Parameter landscape: where is the system fragile?}
  ...
  \end{itemize}
  \centering
  \includegraphics[width=0.92\linewidth]{fig4a_chi_rc_landscape.pdf}
\end{frame}
...
\begin{frame}{Structural levers: local coupling}
  ...
  \end{itemize}
  \centering
  \includegraphics[width=0.92\linewidth]{fig4d_beta_effect.pdf}
\end{frame}
...
\begin{frame}{Backup: H2 density diagnostics (4H vs 12H)}
  \centering
  \includegraphics[width=0.92\linewidth]{s5_h2_density_4h.pdf}
  \vspace{0.4em}
