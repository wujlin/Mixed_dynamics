...
% Figures may be referenced from two common Overleaf layouts:
% - Project root contains `Essay/` (compile from root): `Essay/figures/`
% - Project root is `Essay/` (compile from `slides/`): `../figures/`
% Keep both so missing files fail loudly (no fallback).
\graphicspath{{../figures/}{../figures_supp/}{Essay/figures/}{Essay/figures_supp/}}
\svgpath{{../figures/}{../figures_supp/}{Essay/figures/}{Essay/figures_supp/}}
