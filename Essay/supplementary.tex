...
\title{Supplementary Materials for:\\Competing feedback channels drive phase transitions in collective~emotion}
\author[1]{Juan Li}
...
We compared LLM-assigned labels to manual ratings on a manually rated subset ($n=5{,}000$). Exact-match accuracy was 85\% for arousal labels (Cohen's $\kappa=0.79$) and 87\% for risk labels ($\kappa=0.82$).
