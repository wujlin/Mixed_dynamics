...
We are pleased to submit our manuscript entitled ``Competing feedback channels drive phase transitions in collective emotion'' for consideration as an Article in \textit{Nature Human Behaviour}.
...
This work contributes to the growing literature on collective behavior and information ecosystems. We believe it will be of interest to \textit{Nature Human Behaviour} readers given the journal's focus on quantitative approaches to social dynamics and the policy relevance of understanding emotional contagion in hybrid media environments.
