...
{\large Jinlin Wu$^{1,\ast}$, Zhihang Liu$^{2,\ast}$}

\vspace{0.5em}

{\small
$^{1}$Urban Governance and Design Thrust, The Hong Kong University of Science and Technology (Guangzhou), Guangzhou 511400, China\\
$^{2}$Institute of Space and Earth Information Science, The Chinese University of Hong Kong, Shatin, Hong Kong, China\\[0.3em]
